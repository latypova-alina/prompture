...
ActiveRecord::Schema[8.0].define(version: 2026_09_07_120455) do
  ...
  create_table "command_image_to_video_requests", force: :cascade do |t|
    ...
    t.string "category"
    t.index ["category"], name: "index_command_image_to_video_requests_on_category"
  ...
  create_table "command_two_frame_to_video_requests", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "category"
    t.index ["category"], name: "index_command_two_frame_to_video_requests_on_category"
  ...
  create_table "flipper_managed_features", force: :cascade do |t|
    t.string "feature_key", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["feature_key"], name: "index_flipper_managed_features_on_feature_key", unique: true
  end
