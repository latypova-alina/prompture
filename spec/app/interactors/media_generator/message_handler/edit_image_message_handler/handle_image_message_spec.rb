...
describe MediaGenerator::MessageHandler::EditImageMessageHandler::HandleImageMessage do
    ...
    it "organizes interactors in correct order" do
      expect(described_class.organized).to eq(
        [
          ...
          MediaGenerator::MessageHandler::EditImageMessageHandler::ValidateImageMessageType,
