  ...
  describe "#to_h" do
    ...
    it "localizes the title, description, and estimate using the given locale" do
      expected_description = I18n.t(
        "telegram_webhooks.commands.buy_credits.pack_description",
        credits: pack[:credits],
        locale:
      )

      expect(pack_hash).to include(
        title: I18n.t("telegram_webhooks.commands.buy_credits.pack_title.medium", locale:),
        description: expected_description,
        estimate: I18n.t("mini_app.buy_credits.pack_estimate.medium", locale:)
      )
    end
