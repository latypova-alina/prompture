...
describe Generator::Media::StoredMedia::MergedVideoUploader do
  ...
  let(:uploaded_url) { "https://internal.example/admin/cartoon/bloomy/videos/with_audio/merged.mp4" }
  ...
  before do
    ...
    allow(StoreMedia::Upload::Facade)
      .to receive(:new)
      .with(bytes: "video-bytes", filename: "merged.mp4", folder: "admin/cartoon/bloomy/videos/with_audio")
