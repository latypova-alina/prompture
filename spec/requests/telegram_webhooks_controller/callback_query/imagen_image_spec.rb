...
describe TelegramWebhooksController, telegram_bot: :rails do
  ...
  describe "#callback_query", :callback_query do
    ...
    context "when callback data is imagen_image" do
      ...
      include_context "stub imagen success request"
      ...
      context "but task creation failed" do
        include_context "stub create imagen task fail request"
      ...
      context "but task retrieval failed" do
        ...
        include_context "stub retrieve imagen task fail request"
      ...
      context "but task retrieved task has FAILED status" do
        include_context "stub create imagen task success request"
        include_context "stub retrieve imagen task with FAILED status"
      ...
      context "when task never completes within max attempts" do
        include_context "stub create imagen task success request"
        include_context "stub retrieve imagen task with IN_PROGRESS status"
