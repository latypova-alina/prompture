...
describe RecordCreators::ButtonRequests::Videos::Hailuo02Standard do
  ...
  it "creates a pending video processing request with hailuo processor" do
    ...
    expect(record.processor).to eq("hailuo_02_standard_image_to_video")
