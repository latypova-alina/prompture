...
describe RecordCreators::ButtonRequests::Videos::Wan do
  ...
  it "creates a pending video processing request with wan processor" do
    ...
    expect(created_record.processor).to eq("wan_2_2_image_to_video")
