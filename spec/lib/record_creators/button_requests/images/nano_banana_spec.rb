...
describe RecordCreators::ButtonRequests::Images::NanoBanana do
  ...
  it "creates a pending image processing request with nano_banana processor" do
    ...
    expect(record.processor).to eq("nano_banana_image")
