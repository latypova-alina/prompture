...
describe RecordCreators::ButtonRequests::Images::Imagen do
  ...
  it "creates a pending image processing request with imagen processor" do
    ...
    expect(record.processor).to eq("imagen_image")
