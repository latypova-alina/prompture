...
describe RecordCreators::ButtonRequests::Images::Mystic do
  ...
  it "creates a pending image processing request with mystic processor" do
    ...
    expect(record.processor).to eq("mystic_image")
