...
describe RecordCreators::ButtonRequests::Images::Flux do
  ...
  it "creates a pending image processing request with flux processor" do
    ...
    expect(record.processor).to eq("flux_image")
