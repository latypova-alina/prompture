RSpec.shared_examples "message handling" do
  ...
  context "when command is known" do
    ...
    let(:expected_markup) do
      {
        inline_keyboard: [
          [{ text: "Extend prompt (1 stone 🪨)", callback_data: "extend_prompt" }],
          [{ text: "Flux 2 Pro (1 stone 🪨)", callback_data: "flux_image" }],
          [{ text: "NanoBanana 2 (1 stone 🪨)", callback_data: "nano_banana_image" }]
        ]
      }
    end
