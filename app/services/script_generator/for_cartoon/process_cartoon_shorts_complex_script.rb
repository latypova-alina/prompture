module ScriptGenerator
  module ForCartoon
    class ProcessCartoonShortsComplexScript
      include Memery
      ...
      delegate :scenes, to: :cartoon_problem_solution_script_context
      delegate :reference_image_url, to: :cartoon_problem_solution_script_context

      def create_image_prompts!
        scene_records.each do |scene|
          CreateSceneImagePrompt.call(scene:)
        end
      end
      ...
      memoize def cartoon_problem_solution_script_context
        CartoonProblemSolutionScriptContext.new
      end
